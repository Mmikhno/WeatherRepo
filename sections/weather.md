...
- В ответ МП получает актуальную на момент запроса информацию о [погодных условиях](#погодные-явления) в районе нахождения ТС и [рекомендации по управлению](#правила-формирования-рекомендаций-по-управлению-тс) ТС в соответствии с метеоданными (при наличии таковых);
  ...
  - При отсутствии ответа в течение 5 минут МП - выводится сообщение: «Погодный сервис временно недоступен, отсутствует ответ от сервера»;
  - Если метеоданные отсутствуют более 40 минут – выводится сообщение: «Погодный сервис временно недоступен, отсутствуют метеоданные более 40 минут»
...
- Выводимая иконка погоды формируется на основании полученных данных с учетом параметров:
  ...
  - [облачность](#характеристики-облачности) – от 0 до 4;
  - [сила ветра](#характеристики-скорости-ветра) – от 0 до 4;
  - интенсивность дождя – от 0 до 3, интенсивность снега – от 0 до 3, интенсивность [смешанных осадков](#характеристики-смешанных-осадков);
  - [град](#характеристики-града) – от 0 до 2;
  - вероятность грозы – да / нет.

    - Одновременное наличие ненулевой интенсивности у дождя и у снега – «Снег с дождем», [интенсивность](#характеристики-смешанных-осадков) берется наибольшая из двух;
